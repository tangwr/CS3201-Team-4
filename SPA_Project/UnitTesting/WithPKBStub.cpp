...
unordered_set<int> WithPKBStub::getAllVarId() {
...
int WithPKBStub::getVarIdByName(string varName) {
...
string WithPKBStub::getVarNameById(int varId) {
...
bool WithPKBStub::isVarInTable(string varName) {
...
unordered_set<int> WithPKBStub::getAllProcId() {
...
int WithPKBStub::getProcIdByName(string varName) {
...
string WithPKBStub::getProcNameById(int procId) {
...
bool WithPKBStub::isProcInTable(string procName) {
...
unordered_set<int> WithPKBStub::getAllConst() {
	return constValues;
}

bool WithPKBStub::isConstInTable(int constValue) {
...
unordered_set<int> WithPKBStub::getAllStmtId() {
...
unordered_set<int> WithPKBStub::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> WithPKBStub::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> WithPKBStub::getAllIfId() {
	return ifStmts;
}

unordered_set<int> WithPKBStub::getAllCallId() {
	return callStmts;
}

int WithPKBStub::getProcCalledByStmt(int callstmtId) {
...
unordered_set<int> WithPKBStub::getStmtCallProc(int procId) {
