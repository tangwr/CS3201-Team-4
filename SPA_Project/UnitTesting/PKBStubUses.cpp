...
unordered_set<int> PKBStubUses::getAllStmtId() {
	return allStmts;
}

unordered_set<int> PKBStubUses::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> PKBStubUses::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> PKBStubUses::getAllIfId() {
	return ifStmts;
}

unordered_set<int> PKBStubUses::getAllCallId() {
	return callStmts;
}

unordered_set<int> PKBStubUses::getAllProcId() {
	return procId;
}

unordered_set<int> PKBStubUses::getAllVarId() {
	return varId;
}

unordered_set<int> PKBStubUses::getAllUseStmt() {
	return useStmts;
}

bool PKBStubUses::checkStmtVarUseRelExist(int stmtId, int varId) {
...
bool PKBStubUses::isProcInTable(string procName) {
...
bool PKBStubUses::isStmtInUseTable(int stmtId) {
...
int PKBStubUses::getVarIdByName(string varName) {
	auto& it = varIdTable.find(varName);
	if (it != varIdTable.end())
		return it->second;
	return -1;
}
int PKBStubUses::getProcIdByName(string procName) {
...
unordered_set<int> PKBStubUses::getUseStmtInProc(int procId) {
...
unordered_set<int> PKBStubUses::getStmtUseVar(int varId) {
	unordered_set<int> stmtSet;
...
unordered_set<int> PKBStubUses::getProcUseVar(int varId) {
...
unordered_set<int> PKBStubUses::getVarUsedByStmt(int stmtId) {
	unordered_set<int> varSet;
	auto& it = usesTable.find(stmtId);
	if (it != usesTable.end())
		return it->second;
