...
NextStarPKBStub::NextStarPKBStub() {
...
unordered_set<int> NextStarPKBStub::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> NextStarPKBStub::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> NextStarPKBStub::getAllIfId() {
	return ifStmts;
}

unordered_set<int> NextStarPKBStub::getAllCallId() {
	return callStmts;
}

int NextStarPKBStub::getNumOfStmt() {
	return 24;
}

unordered_set<int> NextStarPKBStub::getPreviousStmt(int a) {
...
unordered_set<int> NextStarPKBStub::getNextStmt(int a) {
...
unordered_set<int> NextStarPKBStub::getStmtParentStarStmt(int a) {
...
bool NextStarPKBStub::isStmtInWhileTable(int a) {
	return whileStmts.find(a) != whileStmts.end();
}

unordered_set<int> NextStarPKBStub::getAllStmtId() {
	return allStmts;
}