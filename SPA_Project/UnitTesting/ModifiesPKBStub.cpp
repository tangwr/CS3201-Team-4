...
ModifiesPKBStub::ModifiesPKBStub() {
...
unordered_set<int> ModifiesPKBStub::getAllStmtId() {
	return allStmts;
}

unordered_set<int> ModifiesPKBStub::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> ModifiesPKBStub::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> ModifiesPKBStub::getAllIfId() {
	return ifStmts;
}

unordered_set<int> ModifiesPKBStub::getAllCallId() {
	return callStmts;
}

unordered_set<int> ModifiesPKBStub::getAllProcId() {
	return procId;
}

unordered_set<int> ModifiesPKBStub::getAllVarId() {
	return varId;
}

unordered_set<int> ModifiesPKBStub::getAllModifyStmt() {
	return modifyStmts;
}

bool ModifiesPKBStub::hasModifyRel(int stmtId, int varId) {
...
bool ModifiesPKBStub::isProcInTable(string procName) {
...
bool ModifiesPKBStub::isStmtInModifyTable(int stmtId) {
...
int ModifiesPKBStub::getVarIdByName(string varName) {
...
int ModifiesPKBStub::getProcIdByName(string procName) {
...
unordered_set<int> ModifiesPKBStub::getModifyStmtInProc(int procId) {
...
unordered_set<int> ModifiesPKBStub::getStmtModifyVar(int varId) {
	unordered_set<int> stmtSet;
...
unordered_set<int> ModifiesPKBStub::getProcModifyVar(int varId) {
...
unordered_set<int>ModifiesPKBStub::getVarModifiedInStmt(int stmtId) {
	unordered_set<int> varSet;
	auto& it = modifiesTable.find(stmtId);
	if (it != modifiesTable.end())
		return it->second;
