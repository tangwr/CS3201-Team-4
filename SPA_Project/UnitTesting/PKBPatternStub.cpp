...
unordered_set<int> PKBPatternStub::getAllVarId() {
...
int PKBPatternStub::getVarIdByName(string varName) {
...
unordered_set<int> PKBPatternStub::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> PKBPatternStub::getStmtInAssignWithVar(int varId) {
	return assignStmtModVar.at(varId);
}

string PKBPatternStub::getExpInAssignStmt(int assignStmtId) {
...
int PKBPatternStub::getVarAtLeftOfAssignStmt(int assignStmtId) {
	return left_varInAssignStmt.at(assignStmtId);
}

bool PKBPatternStub::isStmtInAssignTable(int stmtId) {
...
unordered_set<int> PKBPatternStub::getStmtInWhileWithCtrlVar(int varId) {
...
int PKBPatternStub::getCtrlVarInWhileStmt(int stmtId) {
...
bool PKBPatternStub::isStmtInWhileTable(int stmtId) {
...
unordered_set<int> PKBPatternStub::getStmtInIfWithCtrlVar(int varId) {
...
int PKBPatternStub::getCtrlVarInIfStmt(int stmtId) {
...
bool PKBPatternStub::isStmtInIfTable(int stmtId) {
