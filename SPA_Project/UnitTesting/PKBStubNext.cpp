...
unordered_set<int> PKBStubNext::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> PKBStubNext::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> PKBStubNext::getAllIfId() {
	return ifStmts;
}

unordered_set<int> PKBStubNext::getAllCallId() {
	return callStmts;
}

int PKBStubNext::getNumOfStmt() {
	return 24;
}

unordered_set<int> PKBStubNext::getPreviousStmt(int a) {
...
unordered_set<int> PKBStubNext::getNextStmt(int a) {
