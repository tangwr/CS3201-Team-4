...
unordered_set<int> AffectsPKBStub::getAllAssignStmt() {
	return assignStmts;
}

int AffectsPKBStub::getVarAtLeftOfAssignStmt(int stmtId) {
...
bool AffectsPKBStub::isStmtInAssignTable(int stmtId) {
...
bool AffectsPKBStub::isStmtInWhileTable(int stmtId) {
...
bool AffectsPKBStub::isStmtInIfTable(int stmtId) {
...
bool AffectsPKBStub::isStmtInCallTable(int stmtId) {
...
int AffectsPKBStub::getProcContainingStmt(int stmtId) {
...
vector<int> AffectsPKBStub::getStmtLstContainedInProc(int stmtId) {
...
unordered_set<int> AffectsPKBStub::getVarModifiedInStmt(int stmtId) {
...
unordered_set<int> AffectsPKBStub::getVarUsedByStmt(int stmtId) {
...
unordered_set<int> AffectsPKBStub::getNextStmt(int stmtId) {
...
unordered_set<int> AffectsPKBStub::getPreviousStmt(int stmtId) {
