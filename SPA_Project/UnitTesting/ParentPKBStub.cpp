...
unordered_set<int> ParentPKBStub::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> ParentPKBStub::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> ParentPKBStub::getAllIfId() {
	return ifStmts;
}

unordered_set<int> ParentPKBStub::getAllCallId() {
	return callStmts;
}

int ParentPKBStub::getNumOfStmt() {
	return 24;
}

int ParentPKBStub::getStmtParentStmt(int a) {
...
unordered_set<int> ParentPKBStub::getStmtChildrenStmt(int a) {
...
unordered_set<int> ParentPKBStub::getAllStmtId() {
	return allStmts;
}