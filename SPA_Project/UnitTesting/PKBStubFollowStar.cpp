...
PKBStubFollowStar::PKBStubFollowStar() {
...
unordered_set<int> PKBStubFollowStar::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> PKBStubFollowStar::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> PKBStubFollowStar::getAllIfId() {
	return ifStmts;
}

unordered_set<int> PKBStubFollowStar::getAllCallId() {
	return callStmts;
}

int PKBStubFollowStar::getNumOfStmt() {
	return 24;
}

unordered_set<int> PKBStubFollowStar::getStmtFollowedByStarStmt(int a) {
...
unordered_set<int> PKBStubFollowStar::getStmtFollowStarStmt(int a) {
...
unordered_set<int> PKBStubFollowStar::getAllStmtId() {
	return allStmts;
}