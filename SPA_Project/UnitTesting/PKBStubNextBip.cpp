...
unordered_set<int> PKBStubNextBip::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> PKBStubNextBip::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> PKBStubNextBip::getAllIfId() {
	return ifStmts;
}

unordered_set<int> PKBStubNextBip::getAllCallId() {
	return callStmts;
}

int PKBStubNextBip::getNumOfStmt() {
	return 24;
}

unordered_set<int> PKBStubNextBip::getPreviousStmt(int a) {
...
unordered_set<int> PKBStubNextBip::getNextStmt(int a) {
...
unordered_set<int> PKBStubNextBip::getStmtParentStarStmt(int a) {
...
bool PKBStubNextBip::isStmtInWhileTable(int a) {
	return whileStmts.find(a) != whileStmts.end();
}

bool PKBStubNextBip::isStmtInCallTable(int a) {
	return callStmts.find(a) != callStmts.end();
}

bool PKBStubNextBip::isStmtInIfTable(int a) {
	return ifStmts.find(a) != ifStmts.end();
}

unordered_set<int> PKBStubNextBip::getAllStmtId() {
	return allStmts;
}

int PKBStubNextBip::getProcContainingStmt(int a) {
	if (myProcTable.find(a) == myProcTable.end())
		return -1;
	return myProcTable.find(a)->second;
}

int PKBStubNextBip::getProcCalledByStmt(int a) {
...
unordered_set<int> PKBStubNextBip::getStmtCallProc(int a) {
...
vector<int> PKBStubNextBip::getStmtLstContainedInProc(int a) {
