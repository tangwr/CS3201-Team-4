...
ParentStarPKBStub::ParentStarPKBStub() {
...
unordered_set<int> ParentStarPKBStub::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> ParentStarPKBStub::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> ParentStarPKBStub::getAllIfId() {
	return ifStmts;
}

unordered_set<int> ParentStarPKBStub::getAllCallId() {
	return callStmts;
}

int ParentStarPKBStub::getNumOfStmt() {
	return 24;
}

unordered_set<int> ParentStarPKBStub::getStmtParentStarStmt(int a) {
...
unordered_set<int> ParentStarPKBStub::getStmtChildrenStarStmt(int a) {
...
unordered_set<int> ParentStarPKBStub::getAllStmtId() {
	return allStmts;
}