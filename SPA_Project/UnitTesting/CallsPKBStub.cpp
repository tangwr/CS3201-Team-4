...
unordered_set<int> CallsPKBStub::getAllProcId() {
	return procId;
}

bool CallsPKBStub::isProcInTable(string procName) {
...
int CallsPKBStub::getProcIdByName(string procName) {
...
unordered_set<int> CallsPKBStub::getProcCalledByProc(int callerProcId) {
