...
private:
	...
	*/
	...
	a direct or indirect parent of any elements in the right list. 
	Returns true if	there exists one such valid relationship, false 
	otherwise.

	@pkb: the storage from which we retrieve information
	@left: the left list
	@right: the right list
	@return: whether any elements in the left list is a direct or 
			indirect parent of any elements in the right list
	*/
	...
	*/
	...
	/*
	Returns the list of tuples where the left value is a direct or 
	indirect parent of the right value based on the intermediate results.
