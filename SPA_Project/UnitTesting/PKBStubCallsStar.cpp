...
PKBStubCallsStar::PKBStubCallsStar() {
	procId = { 0,1,2 };
...
unordered_set<int> PKBStubCallsStar::getAllProcId() {
	return procId;
}

bool PKBStubCallsStar::isProcInTable(string procName) {
...
int PKBStubCallsStar::getProcIdByName(string procName) {
...
unordered_set<int> PKBStubCallsStar::getProcCalledByStarProc(int callerProcId) {
