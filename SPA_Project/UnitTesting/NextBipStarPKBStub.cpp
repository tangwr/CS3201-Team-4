...
NextBipStarPKBStub::NextBipStarPKBStub() {
...
unordered_set<int> NextBipStarPKBStub::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> NextBipStarPKBStub::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> NextBipStarPKBStub::getAllIfId() {
	return ifStmts;
}

unordered_set<int> NextBipStarPKBStub::getAllCallId() {
	return callStmts;
}

int NextBipStarPKBStub::getNumOfStmt() {
	return 24;
}

unordered_set<int> NextBipStarPKBStub::getPreviousStmt(int a) {
...
unordered_set<int> NextBipStarPKBStub::getNextStmt(int a) {
...
unordered_set<int> NextBipStarPKBStub::getStmtParentStarStmt(int a) {
...
bool NextBipStarPKBStub::isStmtInWhileTable(int a) {
	return whileStmts.find(a) != whileStmts.end();
}

bool NextBipStarPKBStub::isStmtInCallTable(int a) {
	return callStmts.find(a) != callStmts.end();
}

bool NextBipStarPKBStub::isStmtInIfTable(int a) {
	return ifStmts.find(a) != ifStmts.end();
}

unordered_set<int> NextBipStarPKBStub::getAllStmtId() {
	return allStmts;
}

int NextBipStarPKBStub::getProcContainingStmt(int a) {
	if (myProcTable.find(a) == myProcTable.end())
		return -1;
	return myProcTable.find(a)->second;
}

int NextBipStarPKBStub::getProcCalledByStmt(int a) {
...
unordered_set<int> NextBipStarPKBStub::getStmtCallProc(int a) {
...
vector<int> NextBipStarPKBStub::getStmtLstContainedInProc(int a) {
