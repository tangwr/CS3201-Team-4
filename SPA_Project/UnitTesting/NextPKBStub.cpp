...
unordered_set<int> NextPKBStub::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> NextPKBStub::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> NextPKBStub::getAllIfId() {
	return ifStmts;
}

unordered_set<int> NextPKBStub::getAllCallId() {
	return callStmts;
}

int NextPKBStub::getNumOfStmt() {
	return 24;
}

unordered_set<int> NextPKBStub::getPreviousStmt(int a) {
...
unordered_set<int> NextPKBStub::getNextStmt(int a) {
...
unordered_set<int> NextPKBStub::getAllStmtId() {
	return allStmts;
}