...
unordered_set<int> FollowPKBStub::getAllAssignStmt() {
	return assignStmts;
}

unordered_set<int> FollowPKBStub::getAllWhileStmt() {
	return whileStmts;
}

unordered_set<int> FollowPKBStub::getAllIfId() {
	return ifStmts;
}

unordered_set<int> FollowPKBStub::getAllCallId() {
	return callStmts;
}

int FollowPKBStub::getNumOfStmt() {
	return 24;
}

int FollowPKBStub::getStmtFollowedByStmt(int a) {
...
int FollowPKBStub::getStmtFollowStmt(int a) {
...
unordered_set<int> FollowPKBStub::getAllStmtId() {
	return allStmts;
}