...
unordered_set<int> PKBStubCalls::getAllProcId() {
	return procId;
}

bool PKBStubCalls::isProcInTable(string procName) {
...
int PKBStubCalls::getProcIdByName(string procName) {
...
unordered_set<int> PKBStubCalls::getProcCalledByProc(int callerProcId) {
