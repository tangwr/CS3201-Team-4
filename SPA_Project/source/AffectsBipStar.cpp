...
AffectsBipStar::AffectsBipStar(Parameter lc, Parameter rc) {
	leftChild = lc;
	rightChild = rc;
...
void AffectsBipStar::setResultToTable(PKB* pkb, ResultTable* intResultTable, ResultTable* affectResultTable) {
...
unordered_set<int> AffectsBipStar::getValidStmts(PKB* pkb, ResultTable* intResultTable, Parameter child) {
...
void AffectsBipStar::dfsToSetResultTable(PKB* pkb, ResultTable* intResultTable, ResultTable* affectResultTable,
...
void AffectsBipStar::fowardDfs(PKB* pkb, ResultTable* affectResultTable, int procId, int startStmt,
								unordered_set<int>* validAffectorStmts, unordered_set<int>* validAffectedStmts) {
...
bool AffectsBipStar::mergeTable(unordered_map<int, unordered_set<int>>* merger, unordered_map<int, unordered_set<int>>* merged) {
...
Type AffectsBipStar::getStmtType(PKB* pkb, int stmtId) {
	if (pkb->isStmtInAssignTable(stmtId)) {
		return ASSIGN;
	}
...
bool AffectsBipStar::isStmtValidResult(int affectorStmtId, unordered_set<int>* validAffectorResults, int affectedStmtId, unordered_set<int>* validAffectedResults) {
...
void AffectsBipStar::setResultTupleToTable(ResultTable* affectResultTable, int affectorStmtId, int affectedStmtId) {
...
void AffectsBipStar::setBooleanToTable(ResultTable* affectResultTable) {
